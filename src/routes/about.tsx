          ...
          >
            <h2 class="text-5xl md:text-7xl font-bold leading-tight tracking-tight">
              <span class="text-white drop-shadow-lg">
                ...
                <br />
                <br />
                Soon, we'll use purchase metadata to provide a digital proof of
                purchase for the entire lifespan of luxury goods, so that brands
                can earn fees verification fees on the $39B resale market, which
                is growing 3 times faster than new sales.
                <br />
                <br />
                Zenobia Pay is a branded pay-by-bank rewards network that is the
                default payment mechanism for all purchases over $200.
              </span>
            </h2>
          </div>
