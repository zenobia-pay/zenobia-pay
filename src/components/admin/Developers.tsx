          ...
          <div class="space-y-6">
                        ...
                        <div class="flex items-center justify-between">
                          <div class="flex items-center">
                            <div class="flex-shrink-0">
                              <div
                                class={`h-8 w-8 rounded-full flex items-center justify-center ${key.type === "live" ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"}`}
                              >
                                <svg
                          ...
                          <div class="flex items-center space-x-4">
                            <span
                              class={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${key.type === "live" ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"}`}
                            >
            ...
            <div class="bg-gray-50 p-6 rounded-lg border border-gray-200">
              ...
              <p class="mt-2 text-sm text-gray-500">
                Your API keys are used to authenticate requests to the Zenobia
                Pay API. Keep your secret keys secure and do not share them in
          ...
          <div class="space-y-6">
                      ...
                      <div class="flex">
                        ...
                        <div class="ml-3">
                          ...
                          <div class="mt-2 text-sm text-yellow-700">
                            <p>
                              These credentials will only be shown once. Make
                              sure to save them securely.
                            </p>
                          </div>
                        </div>
                      </div>
            ...
            <div class="bg-gray-50 p-6 rounded-lg border border-gray-200">
              ...
              <p class="mt-2 text-sm text-gray-500">
                ...
                applications, scheduled jobs, or any backend service that needs
                to call our API.
              </p>
              <p class="mt-2 text-sm text-gray-500">
          ...
          <div class="space-y-6">
            ...
            <div class="bg-gray-50 p-6 rounded-lg border border-gray-200">
              ...
              <p class="mt-2 text-sm text-gray-500">
                ...
                events happen in your Zenobia Pay account. For example, when a
                payment is completed or when a transfer fails.
              </p>
              <p class="mt-2 text-sm text-gray-500">
        ...
        <Show when={activeTab() === "logs"}>
          <div class="space-y-6">
            ...
            <div class="bg-gray-50 p-6 rounded-lg border border-gray-200">
              ...
              <p class="mt-2 text-sm text-gray-500">
                Event logs provide a history of all API requests, webhook
                deliveries, and system events related to your account. Use these
                logs to debug integration issues or monitor system activity.
              </p>
              <p class="mt-2 text-sm text-gray-500">
                Logs are retained for 30 days. For longer retention, consider
                exporting logs or setting up webhook monitoring.
              </p>
            </div>
          </div>
        </Show>
          ...
          <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div class="bg-white overflow-hidden shadow rounded-lg divide-y divide-gray-200">
                ...
                <div class="px-4 py-5 sm:p-6">
                  <p class="text-sm text-gray-500">
                    Client libraries for various programming languages to help
                    you integrate with our API quickly.
                  </p>
              ...
              <div class="bg-white overflow-hidden shadow rounded-lg divide-y divide-gray-200">
                ...
                <div class="px-4 py-5 sm:p-6">
                  <p class="text-sm text-gray-500">
                    Step-by-step guides to help you implement common payment
