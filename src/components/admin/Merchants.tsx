  ...
  return (
    <div>
      <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold text-gray-900">Merchant Dashboard</h1>
        <button
        ...
        <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div class="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                ...
                <div>
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        type="text"
                        value={merchantUpdate().merchantLocation?.address || ""}
                        onInput={(e) =>
                          setMerchantUpdate((prev) => ({
                            ...prev,
                            merchantLocation: {
                    ...
                    <div>
                      ...
                      <input
                        type="number"
                        value={merchantUpdate().merchantLocation?.latitude || 0}
                        onInput={(e) =>
                          setMerchantUpdate((prev) => ({
                            ...prev,
                            merchantLocation: {
            ...
            <div class="px-4 py-3 bg-gray-50 text-right sm:px-6 flex justify-end space-x-3">
              ...
              >
                {isMerchantUpdateLoading() ? "Updating..." : "Update Merchant"}
              </button>
            </div>
          </div>
        </div>
